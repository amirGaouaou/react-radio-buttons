...
var RadioButton = exports.RadioButton = function (_Component2) {
  ...
  _createClass(RadioButton, [{
    ...
    value: function getStyles() {
      ...
      var selectedColorType = _props4.selectedColorType;
      var selectedTextColor = _props4.selectedTextColor;
      var borderWidth = _props4.borderWidth;
    ...
    value: function render() {
      ...
      var hidden = _props6.hidden;
      var iconMarginTop = _props6.iconMarginTop;
      var iconLocation = _props6.iconLocation;
      var iconWidth = _props6.iconWidth;
      ...
      return _react2.default.createElement(
        'div',
        { className: 'radio-button ' + (checked ? 'checked' : ''), style: buttonStyle, onClick: this.onClick },
        _react2.default.createElement(
          ...
          hidden ? undefined : _react2.default.createElement(RadioIcon, { size: iconSize, innerSize: iconInnerSize,
...
RadioButton.propTypes = {
  ...
  iconMarginTop: _propTypes2.default.string,
  selectedColorType: _propTypes2.default.string,
  selectedTextColor: _propTypes2.default.string,
...
var ReversedRadioButton = exports.ReversedRadioButton = function (_Component3) {
  ...
  _createClass(ReversedRadioButton, [{
    ...
    value: function getStyles() {
      ...
      var selectedColorType = _props7.selectedColorType;
      var selectedTextColor = _props7.selectedTextColor;
      var borderWidth = _props7.borderWidth;
    ...
    value: function render() {
      ...
      var hidden = _props9.hidden;
      var iconLocation = _props9.iconLocation;
      var iconWidth = _props9.iconWidth;
      var iconMarginTop = _props9.iconMarginTop;
...
var RadioIcon = exports.RadioIcon = function (_Component4) {
  ...
  _createClass(RadioIcon, [{
    ...
    value: function getStyles() {
      ...
      var iconLocation = _props10.iconLocation;
      var iconMarginTop = _props10.iconMarginTop;
      var iconWidth = _props10.iconWidth;
      var checked = _props10.checked;

      var defaultSize = size || 10;
      var alignSelf = 'flex-start';
      var calInnerSize = innerSize || Math.round(0.5 * defaultSize);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'radio-icon ' + (checked ? 'checked' : ''), style: iconStyle },
